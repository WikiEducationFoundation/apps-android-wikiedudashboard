...
class ProfileStatsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        configureAsStudent()
        configureAsByStudent()
    }

    private fun configureAsByStudent() {
    ...
    private fun configureAsStudent() {
    ...
    private fun setViewsToHide(vararg views: View) {
        views.forEach {
            it.visibility = View.GONE
        }
    }

    private fun setViewsToShow(vararg views: View) {
        views.forEach {

...
/**Declares the WikiEduDashboardApi  and SharedPref as a private property in the constructor.
 * */
class DashboardRepositoryImpl(private val wikiEduDashboardApi: WikiEduDashboardApi, private val sharedPrefs: SharedPrefs) : DashboardRepository {
     ...
     **/
    override suspend fun requestDashboardDetail(cookies: String): List<CourseListData> = withContext(Dispatchers.IO) {
